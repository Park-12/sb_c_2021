...
import com.shp.exam.demo.service.ArticleService;
...
public class UsrArticleController {
	...
	@ResponseBody
	public ResultData<Article> doMdofiy(HttpSession httpSession, int id, String title, String body) {
		boolean isLogined = false;
		int loginedMemberId = 0;
